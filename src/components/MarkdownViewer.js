  ...
  return (
    <>
      <div className="toolbar">
        <button className="toolbar-button" onClick={handleChangecolorButtonClick}>
          <AiOutlineBgColors />
        </button>
        <button className="toolbar-button" onClick={handleBoldKeyPress}>
          <AiOutlineBold />
        </button>
        <button className="toolbar-button" onClick={handleItalicKeyPress}>
          <AiOutlineItalic />
        </button>
        <button className="toolbar-button" onClick={handleUnderlineKeyPress}>
          <AiOutlineUnderline />
        </button>
      </div>
